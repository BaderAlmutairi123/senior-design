...
-- Focus: Social engineering attack simulations
...
(
  ...
  'You receive several emails with links that look suspicious. Analyze the URLs and decide whether to click or report them — one wrong click could compromise your account.',
  'phishing_email',
  'intermediate',
  '{
...
(
  'Quid Pro Quo Attack',
  'Someone calls offering free tech support or a prize in exchange for your login credentials. Experience how attackers use favors and offers to extract sensitive information.',
  'vishing',
  'advanced',
  '{
...
(
  ...
  'Your social media accounts are being targeted. Attackers are impersonating your friends, your company, and sending you suspicious links. Can you spot the fakes?',
  'phishing_email',
  'beginner',
  '{
    "instructions": "You are browsing your social media accounts when you notice several suspicious activities. Evaluate each situation and decide the safest course of action.",
    "background": "Social media is a goldmine for social engineers. Attackers create fake profiles, impersonate brands, and send malicious links through direct messages. The casual nature of social media makes people more likely to click without thinking.",
    "questions": [
      {
        "question": "You receive a direct message on LinkedIn from a connection: \"I saw this article about you! Check it out: [link].\" This person normally only posts about work topics. What should you do?",
        "options": ["A) Click the link — your connection shared it so it must be safe", "B) Verify with the person through another channel, as their account may be compromised", "C) Share the link with colleagues to check if it is real", "D) Reply on LinkedIn asking if they sent it"]
      },
      {
        "question": "You see a Twitter account called @YourCompany_Support responding to customer complaints and asking people to DM their account details. Your company real support handle is @YourCompanyHelp. What is happening?",
        "options": ["A) A DDoS attack on social media", "B) Brand impersonation — attackers are pretending to be your company support to steal customer credentials", "C) A legitimate support expansion by the marketing team", "D) An automated bot that is harmless"]
      },
      {
        "question": "Which of the following is a safe practice when using social media for work?",
        "options": ["A) Accepting all connection requests to grow your network", "B) Sharing your work email on public posts for networking", "C) Verifying account legitimacy, limiting personal info shared publicly, and being cautious of unsolicited messages with links", "D) Using the same password for social media and work accounts for convenience"]
      }
    ],
    "explanations": [
      "Verify through another channel (B). Compromised accounts frequently send phishing links to all connections. The unusual behavior is a strong warning sign. Never click suspicious links, and do not reply on the same platform since the attacker controls that account.",
      "Brand impersonation (B). Attackers create lookalike accounts to trick frustrated customers into sharing login credentials and payment information. Always verify support accounts are official before sharing any details.",
      "Being cautious and verifying (C) is the safest approach. Accepting all requests (A) exposes you to fake profiles. Sharing your work email publicly (B) invites targeted phishing. Reusing passwords (D) means one breach compromises everything."
    ]
  }'::jsonb,
  '{"answers": ["B", "B", "C"]}'::jsonb,
  100,
...
(
  ...
  'You are working in public spaces — coffee shops, airports, coworking areas. Attackers are watching and listening. Can you protect your sensitive information?',
  'pretexting',
  'intermediate',
  '{
...
(
  ...
  'Not all threats come from outside. A coworker is acting suspiciously — downloading files they should not access, asking unusual questions. Can you recognize the warning signs?',
  'pretexting',
  'advanced',
  '{
    "instructions": "You notice some unusual behavior from colleagues at work. Evaluate each situation to determine if it represents an insider threat and what the appropriate response should be.",
    "background": "Insider threats come from people within the organization who misuse their access. They may steal data, sabotage systems, or leak information. These threats are dangerous because insiders already have legitimate access and know where sensitive data is stored.",
    "questions": [
      {
        "question": "A coworker who submitted their resignation is detected downloading large volumes of proprietary files to a personal USB drive two days before their last day. What should you do?",
        "options": ["A) Let it go since they probably just want copies of their own work", "B) Wait until they leave and then check what was downloaded", "C) Immediately notify the security team and your manager, and let them handle restricting access and preserving evidence", "D) Send them an email reminder about the data policy"]
      },
      {
        "question": "A colleague from marketing repeatedly asks you for access to engineering databases, claiming they need it for a presentation. Their manager has not authorized this access. What is the most concerning aspect?",
        "options": ["A) They are working late occasionally", "B) They are consistently trying to access files and systems outside their job role without proper authorization", "C) They asked for a raise recently", "D) They prefer to work alone"]
      },
      {
        "question": "What is the best way for an organization to reduce insider threats without creating a toxic surveillance culture?",
        "options": ["A) Monitor every employee email and browsing activity without telling them", "B) Combine least-privilege access, behavior analytics, regular access reviews, and a culture where people feel comfortable reporting concerns", "C) Ban all USB drives and personal devices from the office", "D) Conduct polygraph tests during hiring"]
      }
    ],
    "explanations": [
      "Notify security immediately (C). Data exfiltration before departure is one of the most common insider threat scenarios. Quick action prevents further data loss and preserves forensic evidence. Waiting (B) allows continued exfiltration, and an email reminder (D) is inadequate for an active incident.",
      "Accessing data outside their role without authorization (B) is the biggest red flag. This behavior directly indicates someone is trying to get information they should not have. The other options (working late, asking for a raise, working alone) are completely normal behaviors.",
      "The balanced approach (B) is most effective. Least-privilege access limits damage. Behavior analytics catch anomalies. Access reviews keep permissions current. A healthy culture encourages reporting without fear. Secret mass surveillance (A) is legally risky and damages trust."
    ]
  }'::jsonb,
  '{"answers": ["C", "B", "B"]}'::jsonb,
  350,
...
(
  ...
  'You are at an airport and need to connect to Wi-Fi. But which network is real and which one is set up by an attacker? One wrong connection could expose all your data.',
  'smishing',
  'beginner',
  '{
    ...
    "explanations": [
      ...
      "This could be a social engineering trick (B). The stranger may have set up a rogue hotspot to perform a man-in-the-middle attack. Even if they seem friendly, connecting to an unknown person's hotspot gives them full visibility into your unencrypted traffic."
    ]
  }'::jsonb,
  '{"answers": ["C", "B", "B"]}'::jsonb,
  100,
